...
//  Project20
//
//  Created by Olha Pylypiv on 29.04.2024.
//
...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        scoreLabel.position = CGPoint(x: 40, y: 40)
    ...
    func explode(firework: SKNode) {
        ...
        if let emitter = SKEmitterNode(fileNamed: "explode") {
            ...
            let destroyEmitter = SKAction.removeFromParent()
            emitter.run(SKAction.sequence([delay, destroyEmitter]))
        }
